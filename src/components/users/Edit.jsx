...
<Input errors={errors} id={'password'} title={'user password'} value={user.password}  type={'password'} name='password' ChangeData={ChangeData}/>

  <div className="mb-3">
    <input type="submit" className="form-control" value="Save User"/>
  </div>
</form>
